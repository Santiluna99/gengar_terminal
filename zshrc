...
PROMPT=$'%{\e[0;31m%}┌─[%{\e[1;34m%}%Broot%{\e[1;33m%}@%{\e[1;36m%}Debian%b%{\e[0;31m%}]─[%{\e[0;32m%}%(4~|/%2~|%~)%{\e[0;31m%}]%b\n%{\e[0;31m%}└──╼ %{\e[1;31m%}%B❯%{\e[1;34m%}❯%{\e[1;90m%}❯%{\e[0m%}%b '

# corsor and it's color
#echo -e '\e[3 q'
echo -ne "\033]12;#00ff00\007"
clear
/home/santi/./../../usr/games/cowsay -f alien.cow santi | lolcat
date | lolcat
echo
alias anon='rm $HISTFILE'
